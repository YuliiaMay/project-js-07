...
// const fetchBtn = document.querySelector('.weather__button');
...
// fetchBtn.addEventListener('click', weekFetch);

// async function weekFetch() {
//   const weekResult = await axios.get(
//     `https://api.openweathermap.org/data/2.5/forecast?lat=${crd.latitude}&lon=${crd.longitude}&appid=${API_KEY}&units=metric`
//   );
//   return weekResult;
// }
